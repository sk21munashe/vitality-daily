...
export default function Auth() {
  ...
  const handleAuth = async () => {
    ...
    try {
      if (isLogin) {
        ...
        // Save health profile to localStorage before signup
        ...
        if (error) throw error;
        toast.success('Account created! Welcome to your wellness journey!');
      }
    } catch (error: any) {
  ...
  const isStepValid = () => {
    switch (currentStep) {
      ...
      case 1: return formData.gender && formData.age && formData.height && formData.weight;
      case 2: return formData.healthGoal;
      case 3: return formData.dietPreference;
      case 4: return formData.activityLevel;
      case 5: return authData.email && authData.password && authData.password.length >= 6;
            ...
            {currentStep === 0 && (
              <div className="text-center py-8">
                <motion.div
                  ...
                  className="w-24 h-24 bg-gradient-to-br from-primary to-accent rounded-3xl flex items-center justify-center mx-auto mb-6"
                >
                  <Sparkles className="w-12 h-12 text-white" />
                </motion.div>
                <h1 className="text-3xl font-bold mb-3">Your AI Health Coach</h1>
                <p className="text-muted-foreground mb-8">
                  Get a personalized wellness plan powered by AI. Track water, calories, and fitness all in one place.
                </p>
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">This helps personalize your plan</p>
                </div>
            ...
            {currentStep === 5 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">Save your progress & sync across devices</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-2xl bg-muted/50 space-y-2">
                    <p className="font-medium text-sm">Your personalized plan:</p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 rounded-full bg-primary/20 text-primary text-xs">
                        {HEALTH_GOALS.find(g => g.value === formData.healthGoal)?.label}
                      </span>
                      <span className="px-2 py-1 rounded-full bg-accent/20 text-xs">
                        {DIET_OPTIONS.find(d => d.value === formData.dietPreference)?.label}
                      </span>
